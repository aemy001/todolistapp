...
if(isset($_POST["submit"])){
  ...
  $insert = "INSERT INTO `users`(`userName`, `userPassword`) VALUES ('$name','".md5($password)."')";
...
?>
                ...
                <form class="mx-1 mx-md-4" method="post">
                  ...
                  <div class="d-flex flex-row align-items-center mb-4">
                    ...
                    <div class="form-outline flex-fill mb-0">
                      <input type="password" id="form3Example4c" class="form-control" name="userPassword" required/>
